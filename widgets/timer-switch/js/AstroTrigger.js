    ...
    class AstroTrigger extends HTMLElement {
        ...
        onDataChanged() {
            if (this.data.astroTime !== this.astroTime || this.data.shiftInMinutes !== this.shiftInMinutes) {
                ...
                const translatedAstroTime = vis.binds["timer-switch"].translate(this.astroTime);
                ...
                iconElement.src = `widgets/timer-switch/img/astro/${this.astroTime}.svg`;
        ...
        createShadowRoot() {
            ...
            shadowRoot.innerHTML = `
				<link rel="stylesheet" href="widgets/timer-switch/css/AstroTrigger.css"/>
				...
				<div class="container edit" style="display: none">
					<label for="time">${vis.binds["timer-switch"].translate("inputAstroTime")}</label>
                    <select id="time" required>
                    	<option value="sunrise" selected>${vis.binds["timer-switch"].translate("sunrise")}</option>
                    	<option value="solarNoon">${vis.binds["timer-switch"].translate("solarNoon")}</option>
                    	<option value="sunset">${vis.binds["timer-switch"].translate("sunset")}</option>
					</select>
					<label for="shift">${vis.binds["timer-switch"].translate("inputShiftInMinutes")}</label>
