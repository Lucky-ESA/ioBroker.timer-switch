    ...
    class Weekdays extends HTMLElement {
        constructor() {
            ...
            this.weekdays = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((s) =>
                vis.binds["timer-switch"].translate(s),
            );
        ...
        createShadowRoot() {
            ...
            shadowRoot.innerHTML = `
				<link rel="stylesheet" href="widgets/timer-switch/css/Weekdays.css"/>
				<link rel="stylesheet" href="widgets/timer-switch/css/material-checkbox.css" />
