(async () => {
    class OneTimeTrigger extends HTMLElement {
        ...
        createShadowRoot() {
            ...
            shadowRoot.innerHTML = `
				<link rel="stylesheet" href="widgets/timer-switch/css/OneTimeTrigger.css"/>
				...
				<div class="container edit">
					<div class="header">
						<img class="button save" src="widgets/timer-switch/img/save-24px.svg" width="28px"
							height="28px" title="${vis.binds["timer-switch"].translate("saveChanges")}"/>
						<img class="button cancel" src="widgets/timer-switch/img/cancel-24px.svg" width="28px"
							height="28px" title="${vis.binds["timer-switch"].translate("cancelEdit")}"/>
					</div>
					<div class="validation-errors-container" style="display: none;">
						<ul id="validation-errors"></ul>
					</div>
					<div>${vis.binds["timer-switch"].translate("switchedValue")}</div>
					<div class="action"></div>
					<div class="condition">
						<div>${vis.binds["timer-switch"].translate("condition")}</div>
						<img class="button add" src="widgets/timer-switch/img/add-24px.svg" width="28px"
							height="28px" title="${vis.binds["timer-switch"].translate("addCondition")}"/>
					</div>
					<div>${vis.binds["timer-switch"].translate("oneTimeTriggerInfo")}</div>
					<div class="trigger">
    ...
    customElements.define("app-one-time-trigger-timer", OneTimeTrigger);
})();
